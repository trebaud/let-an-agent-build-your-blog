...
export const CONFIG = {
  ...
  BLOG_BRAND: "my little notebook",
  BLOG_SUBTITLE: "thoughts, doodled in the margins",
  // Public URL of the stylesheet (output path is wired up in ../core/build.ts).
  STYLES_HREF: "/assets/css/index.css",
  SOCIALS: [
    { title: "scribbles on github", href: "https://github.com/your-handle/let-an-agent-build-your-blog" },
    { title: "subscribe (rss)", href: "/feed.xml" },
  ],
